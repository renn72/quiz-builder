    ...
    if (isDisabled)
      return (
        <Button
          ...
          variant={'outline'}
          className={cn(
            'flex h-full min-h-[36px] w-full cursor-pointer items-center justify-between',
            'rounded-md border px-3 py-1 data-[state=open]:border-ring',
            className,
          )}
        >
          ...
      ...
      >
        <PopoverTrigger asChild>
          <Button
            variant={'outline'}
            className={cn(
              'flex h-full min-h-[36px] w-full cursor-pointer items-center justify-between rounded-md border px-3 py-1 data-[state=open]:border-ring',
              className,
            )}
          >
            <div
